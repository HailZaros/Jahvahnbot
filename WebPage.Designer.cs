namespace Jahvahnbot
{
	partial class WebPage
	{
		...
		private void InitializeComponent()
		{
			...
			this.webBrowser1.Url = new System.Uri("https://api.twitch.tv/kraken/oauth2/authorize?response_type=token&client_id=fp7qy" +
        "svtfwcqtn82qugychg0osl2rje&redirect_uri=http://localhost&scope=chat_login", System.UriKind.Absolute);
